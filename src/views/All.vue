      ...
      <a-tab-pane  v-for="item in listTab" :key="item.key" :tab="item.tab">
        ...
        <template #bodyCell="{ column, record }">
          ...
          <template v-if="column.key === 'age'">
            <span
            :style="{ color: record.age % 2 === 0 ? '#ff3737' : '#3182f7', fontSize:'12px' }"
                >
                617원
            </span>
          </template>
